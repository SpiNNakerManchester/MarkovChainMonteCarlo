...
class LightHouseModel(MCMCModel):
    ...
    def get_parameters(self) -> List[MCMCParameter]:
        return [
            ...
            MCMCParameter(self._alpha_min, numpy.float64),
            MCMCParameter(self._alpha_max, numpy.float64),
            MCMCParameter(self._beta_min, numpy.float64),
            MCMCParameter(self._beta_max, numpy.float64)
        ]
